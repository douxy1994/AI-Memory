...
public sealed class AgentCatalog
{
    ...
    [
        ...
        new("windsurf", "Windsurf Cascade", ["windsurf"], [".codeium\\windsurf", "AppData\\Local\\Programs\\Windsurf"], true),
        new("kiro", "Kiro", ["kiro", "kiro-cli", "kiro-cli-chat"], [".kiro", "AppData\\Local\\Programs\\Kiro"], true),
