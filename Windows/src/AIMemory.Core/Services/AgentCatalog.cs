...
public sealed class AgentCatalog
{
    ...
    [
        ...
        new("antigravity", "Google Antigravity", ["antigravity"], [".gemini\\antigravity-cli"], true),
        ...
        new("roo", "Roo Code", ["roo"], ["AppData\\Roaming\\Code\\User\\globalStorage\\rooveterinaryinc.roo-cline"], false),
        ...
        new("trae", "Trae", ["trae"], ["AppData\\Local\\Programs\\Trae"], false),
        ...
        new("codebuddy", "CodeBuddy", ["codebuddy"], [".codebuddy"], false),
        ...
        new("rovo-dev", "Atlassian Rovo Dev", ["acli"], [".rovodev"], false),
