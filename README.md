...
- 检测 117 种 Agent、通用 AI CLI 与本地模型 CLI；除主流编码 Agent 外，还覆盖 Hugging Face CLI、Microsoft 365 Agents Toolkit、GitHub Agentic Workflows、Neovate、VT Code、Dexto、nanobot、ZeroClaw、PicoClaw、IronClaw、NullClaw、Moltis、OpenSquilla、Qodo、CodeRabbit、Poolside、Command Code、Ante、Mentat、Claw Code、Coro、Nori、CodeMachine、Open Codex、Groq Code CLI、Devon、g3、Mini-Kode、zot、VibePod、Every Code、Claw Code Agent、Gitagent、Ollama 与 LM Studio CLI 等工具；
